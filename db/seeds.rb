...
if Author.count == 0
  ...
  url = "http://cdn8.openculture.com/wp-content/uploads/2012/02/james-joyce.jpg"
  open(url, "rb") do |file|
    author.photo = file
  end
  author.save
  ...
  url = "http://blogs.cornell.edu/exlibris/files/2014/05/0111201286-Vonnegut-2jmtruq.jpg"
  open(url, "rb") do |file|
    author.photo = file
  end
  author.save
  ...
  url = "http://media-2.web.britannica.com/eb-media/11/79911-004-5B795F1E.jpg"
  open(url, "rb") do |file|
    author.photo = file
  end
  author.save
